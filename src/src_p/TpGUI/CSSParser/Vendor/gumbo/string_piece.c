 ...
 * @LastEditors: hywang
 * @LastEditTime: 2024-08-07 16:33:46
 * @FilePath: /pix-singlegui/PixSingleGUI/src_p/ExternUtils/CSSParser/Vendor/gumbo/string_piece.c
 * @Description: 
 * 
 * PiXOS
 */
...
void gumbo_string_copy(GumboStringPiece* dest, const GumboStringPiece* source) {
  ...
  char* buffer = (char*)gumbo_malloc(source->length);
