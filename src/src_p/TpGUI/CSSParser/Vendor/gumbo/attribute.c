/*
 * @Author: hywang
 * @Date: 2024-08-06 16:48:32
 * @LastEditors: hywang
 * @LastEditTime: 2024-08-07 11:43:24
 * @FilePath: /pix-singlegui/PixSingleGUI/src_p/ExternUtils/CSSParser/Vendor/gumbo/attribute.c
 * @Description: 
 * 
 * PiXOS
 */
    ...
    GumboElement *element, const char *name, const char *value)
{
  ...
  if (!attr) {
    attr = (GumboAttribute *)gumbo_malloc(sizeof(GumboAttribute));
    attr->value = NULL;
...
void gumbo_element_remove_attribute_at(GumboElement *element, unsigned int pos) {
  GumboAttribute *attr = (GumboAttribute *)element->attributes.data[pos];
